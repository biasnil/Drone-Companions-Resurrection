...
function DCO:new()
    ...
    nativeSettings.addSubcategory("/DCO/Language", Subtab_5)
    ...
    nativeSettings.addSelectorString("/DCO/Language", Language_String, Language_Description, languageNames, currentLangIndex, 1, function(value)
        ...
        print("DCO: Language changed to " .. selectedLang.name .. " (" .. selectedLang.code .. ")")
        print("DCO: Please restart the game or reload your save for full language changes to take effect.")
    end)
end
...
function refreshLanguageVariables()
    -- This function updates all the language-dependent variables
