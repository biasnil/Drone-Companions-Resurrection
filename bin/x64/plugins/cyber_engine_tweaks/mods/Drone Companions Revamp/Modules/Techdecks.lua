...
function DCO:new()
	...
	addToList("DCO.SelfDestructSE.packages", "BaseStatusEffect.SuicideWithWeapon_inline3")
	TweakDB:SetFlatNoUpdate("DCO.SelfDestruct.instigatorPrereqs", {})
	TweakDB:SetFlat("DCO.SelfDestruct.targetPrereqs", {})
	...
	TweakDB:SetFlatNoUpdate("DCO.ExplodeBonusStacks.statModsLimit", -1, 'Int32')
	...
	TweakDB:CloneRecord("DCO.AndroidDeathExplosion", "Attacks.EMPGrenadeCommon")
	TweakDB:SetFlatNoUpdate("DCO.AndroidDeathExplosion.playerIncomingDamageMultiplier", 1, 'Float')
	...
	createTechDeckEffectDescription("DCO.MechRegenDesc", MechRegen_String)
	...
	createStat("DCO.DroneFlyingExplosions", "BaseStats.HasWallRunSkill")
	...
	setF("DCO.OverdriveMassEffector.level", 70.0)
	...
	setF("DCO.DroneCloakMassEffector.level", 69.0)
	...
	TweakDB:SetFlatNoUpdate("DCO.DroneHackDamageEffector_inline0.statModsLimit", -1, 'Int32')
	...
	TweakDB:SetFlatNoUpdate("DCO.DroneRegenAbility_inline3.startDelay", 2, 'Float')
	...
	TweakDB:SetFlatNoUpdate("DCO.HealthMonitorBombMultiPrereq.nestedPrereqs", { "DCO.HealthMonitorBombMultiPrereq_inline0" })
...
function createStatusEffectAbility(recordName, toClone, statusEffect, damageType)
	...
	TweakDB:SetFlat(recordName.."MultiPrereq.nestedPrereqs", {recordName.."_inline2"})
...
function createTechDeck(recordName, displayName, localizedDescription, whiteDescriptionList, statList, quality, memory, techhacklist)
	...
	built_stats = {recordName.."_inline420", recordName.."_inline69"}
